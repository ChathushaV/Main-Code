...
# DR plot
fig,ax = plt.subplots()
ax.set_title('Dispersion relationship for [10,10] BNNTs')
ax.set_xlabel('Wavenumber [rad/m]')
ax.set_ylabel('Frequency [rad/s]')

# Group VElocity plot
fig2,ax2 = plt.subplots()
ax2.set_title('Group Velcoity of [10,10] BNNT phonons')
...
ax4.plot(T_cp,cp)
ax4.set_title('Temperature Dependence of Specific Heat Capacity of (10,10) BNNTs')
...
ax5.set_title('Temperature Dependence of Conductance of (10,10) BNNTs')
