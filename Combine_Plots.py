...
ax3.plot(s_T,CNT_s_fit, 'r.', markerfacecolor='none', label = 'Polynomial fit of speculairty of CNT [10,10]')
ax3.plot(s_T,BNNT_s, 'k', label = 'Speculairty of BNNT [10,10]')
ax3.plot(s_T,BNNT_s_fit, 'g.', markerfacecolor='none', label = 'Polynomial fit of speculairty of BNNT [10,10]')
